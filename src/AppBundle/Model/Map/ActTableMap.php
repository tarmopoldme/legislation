...
class ActTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Abbreviation', 'Text', 'Xml', 'Url', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'abbreviation', 'text', 'xml', 'url', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(ActTableMap::COL_ID, ActTableMap::COL_NAME, ActTableMap::COL_ABBREVIATION, ActTableMap::COL_TEXT, ActTableMap::COL_XML, ActTableMap::COL_URL, ActTableMap::COL_CREATED_AT, ActTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'abbreviation', 'text', 'xml', 'url', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Abbreviation' => 2, 'Text' => 3, 'Xml' => 4, 'Url' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'abbreviation' => 2, 'text' => 3, 'xml' => 4, 'url' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
        self::TYPE_COLNAME       => array(ActTableMap::COL_ID => 0, ActTableMap::COL_NAME => 1, ActTableMap::COL_ABBREVIATION => 2, ActTableMap::COL_TEXT => 3, ActTableMap::COL_XML => 4, ActTableMap::COL_URL => 5, ActTableMap::COL_CREATED_AT => 6, ActTableMap::COL_UPDATED_AT => 7, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'abbreviation' => 2, 'text' => 3, 'xml' => 4, 'url' => 5, 'created_at' => 6, 'updated_at' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
